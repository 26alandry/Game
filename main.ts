...
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    animation.runImageAnimation(
    mySprite,
    assets.animation`Rin Walking Left`,
    200,
    true
    )
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestClosed, function (sprite, location) {
    if (Items_Collected == TotalItems) {
        game.setGameOverMessage(true, "You got all the items!")
        game.gameOver(true)
    } else {
        game.setGameOverMessage(false, "Didn't collect all items.")
        game.gameOver(false)
    }
})
controller.right.onEvent(ControllerButtonEvent.Pressed, function () {
    animation.runImageAnimation(
    mySprite,
    assets.animation`Rin Walking Right`,
    200,
    true
    )
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile2`, function (sprite, location) {
    info.changeLifeBy(-3)
    game.setGameOverMessage(false, "You tripped and died.")
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    game.setGameOverMessage(false, "Lock off.")
})
let TotalItems = 0
...
mySprite = sprites.create(assets.image`Rin`, SpriteKind.Player)
info.setLife(3)
Items_Collected = 0
...
scene.setBackgroundImage(img`
    ...
    9999999999999999999999999ddddddd999dd9999999999dddd9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999399999999999999
...
myEnemy = sprites.create(assets.image`Isagi`, SpriteKind.Enemy)
tiles.placeOnTile(myEnemy, tiles.getTileLocation(9, 13))
myEnemy2 = sprites.create(assets.image`Isagi`, SpriteKind.Enemy)
tiles.placeOnTile(myEnemy2, tiles.getTileLocation(25, 13))
myEnemy3 = sprites.create(assets.image`Isagi`, SpriteKind.Enemy)
tiles.placeOnTile(myEnemy3, tiles.getTileLocation(38, 13))
myEnemy4 = sprites.create(assets.image`Isagi`, SpriteKind.Enemy)
tiles.placeOnTile(myEnemy4, tiles.getTileLocation(50, 13))
myEnemy5 = sprites.create(assets.image`Isagi`, SpriteKind.Enemy)
tiles.placeOnTile(myEnemy5, tiles.getTileLocation(65, 13))
tiles.placeOnTile(MySprite3, tiles.getTileLocation(17, 7))
tiles.placeOnTile(MySprite4, tiles.getTileLocation(27, 11))
tiles.placeOnTile(MySprite5, tiles.getTileLocation(42, 10))
tiles.placeOnTile(MySprite6, tiles.getTileLocation(65, 10))
TotalItems = 4
forever(function () {
    myEnemy.vx = -25
    animation.runImageAnimation(
